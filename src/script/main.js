(function ($) {
	...
	class Silence {
		constructor() {
			this.defaluts = {
				...
				sponsor: {
					enable: true,
					paypal: null,
					wechat: 'https://www.cnblogs.com/images/cnblogs_com/zouwangblog/1477590/t_%e5%be%ae%e4%bf%a1%e5%9b%be%e7%89%87_20190704175553.png', //微信二维码
		...
		getMainMode() {
			...
			document.addEventListener('visibilitychange', function () {
				if (document.visibilityState == 'hidden') {
					clearTimeout(time);
					document.title = '你别走,我想你了';
				} else {
					document.title = '好高兴,你回来了';
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/lovelyemperor">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/zouwangblog/articles/11340077.html">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
		...
		buildPostCodeCopyBtns() {
			...
			$.getScript(`https://cdn.jsdelivr.net/gh/lovelyemperor/cnblogs/src/script/clipboard.min.js`, () => {
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/xuqicheng/" alt="富士的雪">' +
					'<ruby><span class="sakuraso">奢靡</span><span class="no">繁</span><span class="shironeko">世间</span>' +
					'<rt class="chinese-font">染指了谁的昨天</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		mainHeader() {
			...
			var header =
					...
					`       <div class="header-info"><p>${config.text} </p>` +
					`           <div class="top-social_v2">` +
					`              <li id="bg-pre"><img class="flipx" src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/13.png"></li>` +
					`              <li><a href="${config.github}" target="_blank" class="social-github" title="github"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/github.png"></a></li>` +
					`              <li><a href="${config.weibo}" target="_blank" class="social-sina" title="sina"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/7.png"></a></li>` +
					`              <li><a href="${config.telegram}" target="_blank" class="social-lofter" title="telegram"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/8.png"></a></li>` +
					`              <li><a href="${config.music}" target="_blank" class="social-wangyiyun" title="CloudMusic"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/10.png"></a></li>` +
					`              <li><a href="${config.twitter}" target="_blank" class="social-wangyiyun" title="Twitter"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/9.png"></a></li>` +
					`              <li><a href="${config.zhihu}" target="_blank" class="social-wangyiyun" title="Zhihu"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/11.png"></a></li>` +
					`              <li><a href="${config.mail}" target="_blank" class="social-wangyiyun" title="E-mail"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/6.png"></a></li>` +
					`              <li id="bg-next"><img src="https://gitee.com/lovelyemperor/xuqicheng/raw/master/img1/13.png"></li>` +
					`           </div>` +
					`      </div>` +
					`</div>` +
					`<div class="wave">` +
		...
		setHomeSuiBiList() {
			...
			for (let i = article_list.length - 1; i >= 0; i--) {
				...
				if (desc_img !== undefined) {
					...
					url = 'https://blog-static.cnblogs.com/files/xuqicheng/11.gif'
				}
